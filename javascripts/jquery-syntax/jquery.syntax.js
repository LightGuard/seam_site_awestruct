...
var Syntax = {root:null,aliases:{},styles:{},lib:{},defaultOptions:{cacheScripts:true,cacheStyleSheets:true},brushes:new ResourceLoader(function(name, callback) {
    ...
    link.attr({rel:"stylesheet",type:"text/css",href:path});
...
jQuery.syntax = function(options, callback) {
    ...
    jQuery(options.blockSelector, context).each(function() {
        jQuery(this).syntax(jQuery.extend({}, options, {brush:Syntax.extractBrushName(this.className),layout:options.blockLayout}), callback);
    });
    jQuery(options.inlineSelector, context).each(function() {
        jQuery(this).syntax(jQuery.extend({}, options, {brush:Syntax.extractBrushName(this.className),layout:options.inlineLayout}), callback);
    });
};
